...
class Posyandu_model extends CI_model
{
    ...
    public function cariDataBalita($keyword)
    {
        ...
        $this->db->like('nama_balita', $keyword);
        $this->db->or_like('tgl_lahir', $keyword);
        $this->db->or_like('jk_balita', $keyword);
        $this->db->or_like('panjang_bdn', $keyword);
        $this->db->or_like('berat_bdn', $keyword);
        $this->db->or_like('nama_ibu', $keyword);

        $result = $this->db->get('tb_balita')->result_array();
        return $result;
    }
}
